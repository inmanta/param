...
To define a form, just create an entity that extends :inmanta:entity:`param::Form`
...
To access a form with only one record, use :py:func:`param::one<param.one>`. Note that you don't get an instance of the form object back, but that you have to get the information out, one field at a time.
